...
module.exports = (sequelize) => {
  ...
  models.LotteryRecord = sequelize.define('LotteryRecord', {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
      primaryKey: true,
      autoIncrement: true
  ...
  // 管理员 - 操作日志
  models.User.hasOne(models.LotteryRecord, { foreignKey: 'user_id', as: 'lotteryRecord' });
  models.LotteryRecord.belongsTo(models.User, { foreignKey: 'user_id', as: 'user' });
